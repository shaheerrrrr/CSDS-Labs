...
public class RestoreItem
{
   ...
   {
      RestoreItem that = (RestoreItem)other;
      return(this.row==that.row && this.col==that.col && this.mapIndex==that.mapIndex && this.value==that.value);
   }
   
   public boolean sameSpot(Object other)
   {
      RestoreItem that = (RestoreItem)other;
      return(this.row==that.row && this.col==that.col && this.mapIndex==that.mapIndex);
   }
