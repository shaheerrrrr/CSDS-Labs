...
public class Achievement
{
   ...
   //given an achievement index (its position in the achievements array), returns the title and description of the achievement
   ...
   //given an achievement index (its position in the achievements array), returns the title without the description
   ...
   //returns the message sent to the client when they unlock an achievement
   ...
   //given an achievement index (its position in the achievements array),unlocks the achievement and sends the client a message to let them know     
   public static void earnAchievement(int index)
   {
      ...
      if(CultimaPanel.achievements[index] == 0)
      {
         ...
         {
            CultimaPanel.rainbowFrame = CultimaPanel.numFrames + ((CultimaPanel.animDelay*3) * Utilities.rollDie(50,100));
...
//****************Achievements
   //read in achiecement data from filename to populate, then return an array of bytes that let the program know which achievments have been earned
   ...
   //writes out the achievement data to fileName
