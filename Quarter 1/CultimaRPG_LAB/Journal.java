...
//topic breakdowns
  //SHOPS
   ...
   //POTIONS   
   public static final byte ALPHAMIND = 0;
   public static final byte FIRESKIN = 1;
   public static final byte INVISIBILITY = 2;
   public static final byte PROTECTION = 3;
   public static final byte SPEED = 4;
   public static final byte STRENGTH = 5;
   //BOOK OR POTION
   public static final byte CURE = 6;
   public static final byte FOCUS = 7;
   public static final byte HEAL = 8;
   //BOOK SPELLS
   public static final byte ANIMATESTONE = 9;
   public static final byte CHARM = 10;
   public static final byte DISARM = 11;
   public static final byte EAGLEEYE = 12;
   public static final byte ENCHANTSTONE = 13;
   public static final byte FEAR = 14;
   public static final byte FIRESTORM = 15;
   public static final byte FLAMEBLAST = 16;
   public static final byte FLIGHT = 17;
   public static final byte FLORETLADE = 18;
   public static final byte KNOWING = 19;
   public static final byte LIGHT = 20;
   public static final byte MAGICMIST = 21;
   public static final byte RAISEDEAD = 22;
   public static final byte RAISEEARTH = 23;
   public static final byte RAISEWATER = 24;
   public static final byte REPEL = 25;
   public static final byte RESTORE = 26;
   public static final byte SHIFTWIND = 27;
   public static final byte TAMEANIMAL = 28;
   public static final byte TEMPEST = 29;
   public static final byte TELEPORT = 30;
   public static final byte TIMESTOP = 31;
   public static final byte UNSEEN = 32;

//STAFF SPELLS
   public static final byte STAFF = 33;
   public static final byte ADVANCE = 34;
   public static final byte BLINDINGLIGHT = 35;
   public static final byte CURSE = 36;
   public static final byte DEATHTOUCH = 37;
   public static final byte FIREBALL = 38;
   public static final byte FIRESHIELD = 39;
   public static final byte ICESTRIKE = 40;
   public static final byte LIGHTNING = 41;
   public static final byte PHASEWALL = 42;
   public static final byte POSSESS = 43;
   public static final byte RAISESTONE = 44;
   public static final byte SUMMONVORTEX = 45;
   public static final byte STONECAST = 46;
   public static final byte SPIDERSWEB = 47;
 //MAGIC ITEMS  
   public static final byte CLOAKS = 48;
   public static final byte ITEMS = 49;
   public static final byte SALEDATES = 50;
   public static final byte NUM_SPELLS = 51;
   ...
   public static final byte CAPITAL = 3;
   public static final byte CASTLE = 4;
   public static final byte CAVE = 5;
   public static final byte CITY = 6;
   public static final byte HUT = 7;  
   public static final byte MINE = 8;
   public static final byte LAIR = 9;
   public static final byte PORT = 10;
   public static final byte SEWER = 11;
   public static final byte TEMPLE = 12;
   public static final byte VILLAGE = 13;
   public static final byte NUM_LOCATIONS = 14;

   //Location types for locations ImageIcon array    
   private static final ImageIcon [] locations = {
   new ImageIcon("images/locations2/arena.Gif"),         /*0 - arena*/
   new ImageIcon("images/locations2/battlefield.Gif"),   /*1 - battlefield*/
   new ImageIcon("images/locations2/camp.Gif"),          /*2 - camp*/
   new ImageIcon("images/locations2/capital.Gif"),       /*3 - capital city*/
   new ImageIcon("images/locations2/castle.Gif"),        /*4 - large_castle*/
   new ImageIcon("images/locations2/mountainCave.Gif"),  /*5 - cave*/
   new ImageIcon("images/locations2/cityM.Gif"),         /*6 - city_center*/
   new ImageIcon("images/locations2/hut.Gif"),           /*7 - hovel*/
   new ImageIcon("images/locations2/mountainMine.Gif"),  /*8 - mine*/
   new ImageIcon("images/locations2/mountainLair.Gif"),  /*9 - mountain_lair*/
   new ImageIcon("images/locations2/portTown.Gif"),      /*10 - port town*/
   new ImageIcon("images/locations2/sewer.Gif"),         /*11 - sewer*/
   new ImageIcon("images/locations2/temple.Gif"),        /*11 - temple*/
...
//                                                 with an Arraylist of multiple sentences for each monster type
   ...
   //ARMS AND ARMORMENTS
      ArrayList<String> [] weaponInfo = new ArrayList[Player.NUM_WEAPONS + 2];  //first element will be for armor, last 2 elements will be for gloves and general info
      ...
      for(int i=0; i < CultimaPanel.player.getSpellIndex() && i < NPC.spellInfo.length; i++)
      {
         ...
         if(temp.contains("~~"))                            //dialogue we want recorded in the journal ends with "~~"
         {
            ...
            if(parts.length == 2)
            {
               ...
               if(parts[1].trim().equals("MISC"))                       //MISC is the flag that it is general spell info
                  spellInformation[NUM_SPELLS].add(info);
               else if(spellIndex >=0 && spellIndex<spellInformation.length)
                  spellInformation[spellIndex].add(info);         //add to the index for that spell
            }
         }
      }
   ...
   //TRAINING
      ...
      for(int i=0; i < CultimaPanel.player.getCraftingInfo() && i < NPC.gemInfo.length; i++)
...
//after the title of the chapter, we can get 20 lines of info per page
   ...
   {	 
      ...
      { 
         String name = CultimaPanel.player.getShortName();
         ...
         ImageIcon temp = new ImageIcon(Player.characters[CultimaPanel.player.getStartStoryIndex()][RIGHT_IMAGE][0]);
         if(CultimaPanel.player.getStartStoryIndex()==Player.BAT || CultimaPanel.player.getStartStoryIndex()==Player.WOLF || CultimaPanel.player.getStartStoryIndex()==Player.CAMP || CultimaPanel.player.getStartStoryIndex()==Player.FLIGHT)
            temp = new ImageIcon(Player.characters[Player.NONE][RIGHT_IMAGE][0]);
      ...
      { 
         ...
         {
            if(y > (CultimaPanel.SIZE * CultimaPanel.SCREEN_SIZE))
               break;
            ...
            y = showPageWithWordWrap(currShop, x, y, g);
            y += SIZE;
         }
      ...
      { 
         ...
         for(byte charIndex=CultimaPanel.journalPageIndex; charIndex<afflictions.length && charIndex<NUM_AFFLICTIONS; charIndex++)
         {
            ...
            y = showPageWithWordWrap(currAffliction, x, y, g);
            y += SIZE;
      ...
      { 
         ...
         for(byte charIndex=CultimaPanel.journalPageIndex; charIndex<locationsArray.length && charIndex<NUM_LOCATIONS; charIndex++)
         {
            ...
            y = showPageWithWordWrap(currLocation, x, y, g);
            y += SIZE;
         ...
         //draw frame to put NPC image into   
            ...
            ImageIcon picture = null;
            if(topIndex >= 0 && topIndex < locations.length)
               picture = locations[topIndex];
      ...
      else if(CultimaPanel.journalChapterIndex == MONSTERS)
      {
         ...
         for(byte charIndex=(byte)(NPC.BUGBEAR + CultimaPanel.journalPageIndex); charIndex<monsterInfo.length && charIndex<=NPC.BRIGAND_SWORD+1; charIndex++)
         {
            ...
            y = showPageWithWordWrap(currMonster, x, y, g);
            y += SIZE;
         }
      ...
      { 
         ...
         if(CultimaPanel.journalPageIndex > Player.NUM_WEAPONS + 1)
            CultimaPanel.journalPageIndex = Player.NUM_WEAPONS + 1;
         for(byte imageIndex=CultimaPanel.journalPageIndex; imageIndex<weaponInfo.length && imageIndex<=Player.NUM_WEAPONS+1; imageIndex++)
         {
            if(y > (CultimaPanel.SIZE * CultimaPanel.SCREEN_SIZE))
               break;
            ...
            if(imageIndex==Player.NUM_WEAPONS)
               name = "Gloves:";	
            ...
            y = showPageWithWordWrap(currWeapon, x, y, g);
            y += SIZE;
         }
         g.setFont(oldP);
         byte topIndex =  CultimaPanel.journalPageIndex;
         if(topIndex >=0 && topIndex<=Player.NUM_WEAPONS)
         {
            ...
            {//draw the weapon's image in the right info-bar if you have information on it   
               ImageIcon temp = new ImageIcon(Player.characters[topIndex][RIGHT_IMAGE][0]);
               if(topIndex == 0)
                  temp = armor;
               else if(topIndex == Player.NUM_WEAPONS)
                  temp = glove;
               else if(topIndex == Player.LUTE)
               {
                  temp = new ImageIcon(Player.guardDown[topIndex][0]);
               }   
               drawPictureInFrame(g, temp);
               x = SIZE * SCREEN_SIZE;
               y = SIZE * 11;
               if(topIndex > 0)
               {
                  ...
                  {//damage, range, speed, price
                     ...
                     g.drawString("Keys - "+Weapon.getKeys(topIndex, ""), x, y+=SIZE);
                  }
               }
            }
            else
      ...
      { 
         ...
         for(byte i=CultimaPanel.journalPageIndex; i<spellInformation.length && i<=NUM_SPELLS; i++)
         {
            ...
            y = showPageWithWordWrap(currSpell, x, y, g);
            y += SIZE;
         }
         g.setFont(oldP);
         if(topIndex >= 0 && topIndex <= ITEMS) 
         {
            ...
            {//draw the weapon's image in the right info-bar if you have information on it   
               ...
               if(topIndex==PHASEWALL || topIndex==CURSE || topIndex==POSSESS || topIndex==FIREBALL || topIndex==ADVANCE || topIndex==STONECAST || topIndex==SPIDERSWEB || topIndex==RAISESTONE
                || topIndex==ICESTRIKE || topIndex==STAFF || topIndex==LIGHTNING || topIndex==DEATHTOUCH || topIndex==FIRESHIELD || topIndex==SUMMONVORTEX || topIndex==BLINDINGLIGHT)
                  temp = new ImageIcon(Player.characters[Player.STAFF][RIGHT_IMAGE][0]);
      ...
      { 
         ...
         for(byte charIndex=CultimaPanel.journalPageIndex; charIndex<townInfo.length && charIndex<=NPC.KING+1; charIndex++)
         {
            ...
            y = showPageWithWordWrap(currNPC, x, y, g);
            y += SIZE;
         }
      //draw frame to put NPC image into   
         g.setFont(oldP);
      ...
      { 
         ...
         if(missions != null && missions.size() > 0)
         {
            ...
            for(int i=CultimaPanel.journalPageIndex; i<missions.size(); i++)
            {
               ...
               y = showSentenceWordWrap(sentence, x, y, g);      
               y += (SIZE);
            }
         }
         //draw the player's image in the right info-bar if you have information on it                                     
      ...
      { 
         ...
         if(visited != null && visited.size() > 0)
         {
            ...
            for(int i=CultimaPanel.journalPageIndex; i<visited.size(); i++)
            {
               if(y > (CultimaPanel.SIZE * CultimaPanel.SCREEN_SIZE))
                  break;
               if(i==CultimaPanel.journalPageIndex)	   //make selected (top) item text a different color
                  g.setColor(new Color(0, 0, 127));
               else
                  g.setColor(new Color(10, 10, 10)); 
      ...
      else if(CultimaPanel.journalChapterIndex == PUZZLES)
      {
         ...
         for(byte i=CultimaPanel.journalPageIndex; i<puzzleInfo.length; i++)
         {
            ...
            y = showPageWithWordWrap(currSection, x, y, g);      
            y += SIZE;
         }
      ...
      else if(CultimaPanel.journalChapterIndex == STATS)
      {
         ...
         g.setColor(new Color(0, 0, 127));
         int arenaLevel = Player.stats[Player.ARENA_LEVEL];
         if(CultimaPanel.achievements[Achievement.MAXIMUS_OVERDRIVE]==1)
         {
            arenaLevel = 50;
         }
         g.drawString("                                             " + arenaLevel, x, y);
         g.setColor(Color.black);
         ...
         if(achievements != null && achievements.size() > 0)
         {
            ...
            else
            {
               if(CultimaPanel.journalPageIndex==Achievement.MINER_2049ER || CultimaPanel.journalPageIndex==Achievement.LIVING_PROOF)
                  temp = new ImageIcon(Player.characters[Player.HAMMER][RIGHT_IMAGE][0]); 
                  ...
                  temp = new ImageIcon(Player.characters[Player.CROSSBOW][RIGHT_IMAGE][0]);
   ...
   //RIGHT info bar
      ...
      g.setFont(readableP);
      if(CultimaPanel.journalChapterIndex == ACHIEVEMENTS)
      {
         g.drawString("(R)", x, y);
         g.drawString("                            to reset achievements", x, y);
      }
      y += SIZE;
   ...
   public static int showPageWithWordWrap(ArrayList<String> pageInfo, int x, int y, Graphics g)
   {
      for(String sentence: pageInfo)
      {
         y = showSentenceWordWrap(sentence,  x,  y,  g);
      }
      return y;
   ...
   public static int showSentenceWordWrap(String sentence, int x, int y, Graphics g)
   {
      //**********WORD WRAP SENTENCE
      String [] words = sentence.split(" ");
      int xAdd = 0;
      for(int j=0; j<words.length; j++)
      {
         ...
         {
            if(j==0 || tempWord.contains("GARRIOTT") || tempWord.contains("SKARA") || tempWord.contains("CAERBANNOG") || tempWord.contains("CULTIMA"))    //proper names should be capitalized
               tempWord = tempWord.charAt(0) + tempWord.substring(1).toLowerCase();
            else
               tempWord = tempWord.toLowerCase();
         }  
         int width = g.getFontMetrics().stringWidth(tempWord);
         if(xAdd + width >= (CultimaPanel.SIZE * CultimaPanel.SCREEN_SIZE)-CultimaPanel.SIZE)
         {
            y += CultimaPanel.SIZE;
            xAdd = CultimaPanel.SIZE;
         }
         if(y > (CultimaPanel.SIZE * CultimaPanel.SCREEN_SIZE))
            break;	
         g.drawString(tempWord, x+xAdd, y);
   ...
   private static ImageIcon getLocationImage(Location location)
   {
      ...
      if(loc.contains("battlefield"))
         return locations[BATTLEFIELD];
      if(loc.contains("large_castle") || loc.contains("castle") || loc.contains("tower"))
         return locations[CASTLE];
      if(loc.contains("city") || loc.contains("fortress"))
         return locations[CITY];
      if(loc.contains("domicile"))
         return locations[HUT];
      if(loc.contains("cave") || loc.contains("insanity"))
         return locations[CAVE];
      if(loc.contains("lair"))
         return locations[LAIR];
      ...
      if(loc.contains("port"))
         return locations[PORT];
      if(loc.contains("capital"))
         return locations[CAPITAL];    
      if(loc.contains("sewer") || loc.contains("dungeon_enterance"))
         return locations[SEWER];  
      return null;
   }
   ...
   private static String getLocationDescription(Location location)
   {
      ...
      if(loc.contains("domicile"))
         return "A solitary thatch hovel: the domicile of a hermit";
      ...
      if(loc.contains("village"))
         return "A small village of thatched hovels, roaming swine and foul";
      ...
      if(loc.contains("sewer"))
         return "An labyrinthine network of tunnels designed to carry away stinking waste"; 
      return "?";
   }
