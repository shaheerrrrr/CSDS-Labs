...
-randomly generated world on a globe surface with 1,000,000 traversable cells
-randomly generated characters with over 100 different player, NPC and monster types
-randomly generated missions with over 100 mission type templates
-50 achievements with in-game achievement tracking
-procedurally random generated locations like villages, cities, caves, camps, temples, castles, towers, sewers and dungeons
-randomly generated music that reacts dynamically to the events in game
-randomly guided weather and events that can alter the world (wind, rain, fog, snow, rainbows, tornados, lightning, forest-fires, floods)
...
-authentic mid-1980's graphics, sound and all-keyboard input
-experience the fantasy medieval dynamics of morality, stealth, training, hunting, crafting, mining, puzzles, marriage, divorce, real estate, pets, sailing, warfare, death, and taxes
...
SHIFT+arrow=> sprint in a particular direction
...
Awareness  => skill in noticing the world and creatures around you, 
              from accurate mapping and knowledge of other's skills to trap/secret detection
...
'A' => Arms, to ask a character about weapons information to log in your journal
...
'M' => Mission if the NPC has one to give, or to resolve a mission that has been completed
...
'R' => Ration, to buy rations from a butcher/baker, or give rations to a downtrodden villager
'S' => Spell, to ask a wiseman to teach a new spell, or get information on spells to log in your journal
'T' => Trade, to ask a shopkeeper to trade goods for gold
...
but will find less help from others, and if extreme, will even be turned away by shopkeepers.
...
Weapon and spell information can be learned from the shopkeepers of armories and magic shops.
