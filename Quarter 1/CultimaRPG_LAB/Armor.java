...
public class Armor extends Item
{
   ...
   public static Armor getRandomArmorFull()
   {
      ...
      armors.add(getBlessedDragonScale());
      armors.add(getBlessedDragonqueen());
      armors.add(getBlessedSeaserpent());
      armors.add(getWolfPelt());
      armors.add(getBearPelt());    
      armors.add(getGreatWolfPelt());
      armors.add(getGreatBearPelt());    
      armors.add(getElkPelt());
   ...
   public static Armor getBlessedDragonScale()
   {
      int[]statM = {0, 0, 0};    //fire protection
      String d = "Blessed armor made from the scales of a dragon that gives protection from flame";
      return new Armor("Blessed-Dragon-scale", 7, statM, 2000, d);
   }
   ...
   public static Armor getBlessedDragonqueen()
   {
      int[]statM = {0, 0, 0};    //fire protection
      String d = "Blessed armor made from the scales of the Dragon Queen that gives protection from flame";
      return new Armor("Blessed-Dragonqueen", 8, statM, 4000,d);
   }
   ...
   public static Armor getBlessedSeaserpent()
   {
      int[]statM = {0, 0, 0};    //cold protection
      String d = "Blessed armor weaved with the scales of a seadragon that gives protection from cold";
      return new Armor("Blessed-Seaserpent", 7, statM, 1000, d);
   }
   ...
   public static Armor getGreatWolfPelt()
   {
      int[]statM = {1, 0, 1};
      String d = "Fur armor sewn from a mighty Greatwolf protects thee from the cold and makes thee feel light and strong";
      return new Armor("Greatwolf-pelt", 2, statM, 100, d);
   }
   
   public static Armor getGreatBearPelt()
   {
      int[]statM = {1, 0, 1};
      String d = "Thick fur sewn from a mighty Greatbear protects thee from the cold and makes thee feel light and strong";
      return new Armor("Greatbear-pelt", 3, statM, 150, d);
   }
   ...
   public static Armor getArmorWithName(String n)
   {
      ...
      if(n.equalsIgnoreCase("blessed-dragon-scale"))
         return getBlessedDragonScale();
      if(n.equalsIgnoreCase("blessed-dragonqueen"))
         return getBlessedDragonqueen();
      if(n.equalsIgnoreCase("blessed-seaserpent"))
         return getBlessedSeaserpent();
      ...
      if(n.equalsIgnoreCase("elk-pelt"))
         return getElkPelt(); 
      if(n.equalsIgnoreCase("greatwolf-pelt"))
         return getGreatWolfPelt();
      if(n.equalsIgnoreCase("greatbear-pelt"))
         return getGreatBearPelt(); 
