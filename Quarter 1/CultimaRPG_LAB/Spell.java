...
//[0]-might, [1]-mind, [2]-agility   
   ...
   public static Spell getAnimateStone()
   {
      int[] statM = {0,0,0};
      String d = "Bring life into a statue that will fight by thy side";
      return new Spell("Animate-stone", "none", -1, 200, statM, 1000, d);
   }
   ...
   public static Spell getFearTorch()
   {
      int[] statM = {0,0,0};
      String d = "Try to frighten off beasts by waving thy torch";
      return new Spell("Fear", "none", 7, 0, statM, 0, d);
   }
   ...
   public static Spell getFireGuard()
   {
      int[] statM = {0,0,0};
      String d = "Guard against flame for a short time";
      return new Spell("Fireskin", "none", 2, 150, statM, 500, d);
   }
   ...
   //give the spell name, returns an instance of the Spell object with that name
   public static Spell getSpellWithName(String n)
   {
      ...
      if(n.equalsIgnoreCase("alphamind"))
         return getAlphaMind();
      if(n.equalsIgnoreCase("animate-stone"))
         return getAnimateStone();
      if(n.equalsIgnoreCase("fireskin"))
         return getFireSkin();
      if(n.equalsIgnoreCase("fireguard"))
         return getFireGuard();
    ...
    //given the spell name, returns a simple description for the game window - a shorter version of the spell's description
   public static String getDescription(String itemName)
   {
      itemName = itemName.trim().toLowerCase();
      if(itemName.equalsIgnoreCase("animate-stone"))
         return "Bring life into a statue as an ally";
