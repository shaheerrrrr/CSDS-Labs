...
public class Terrain extends AnimatedEntity
{
   ...
   private String [] narrative;                 //narrative description for traveling over this terrain type (walking, horseback, rowing, sailing, flying)
   public static final int WALKING = 0, HORSEBACK = 1, ROWING = 2, SAILING = 3, FLYING = 4;
   ...
   public Terrain(String name, ArrayList<String> fileNames, HashMap<String, Integer> nei, String d,  int mi, byte v, String [] n)
   {
      this(name, fileNames, nei, d, mi, v);
      narrative = n;
   }
   ...
   public String getNarrative(int travelType)
   {
      if(Display.frozenWater() && (this.description.toLowerCase().contains("shallow") || this.description.toLowerCase().contains("deep")))
      {
         return "Sliding across solid ice";
      }
      if(narrative!=null && travelType >= 0 && travelType < narrative.length)
         return narrative[travelType];
      return null;
   }
   ...
   */
   ...
   public static ArrayList<Terrain> loadTerrain()
   {
      ...
      String [] nar = {"","","","","Swooping over a towering mountain"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar2 = {"Trudging up a rugged mountain path","Navigating a rugged mountain path","","","Gliding over rugged mountains"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar2));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar3 = {"Hiking over rocky hills","Trotting over rock-strewn hills","","","Soaring over rock-speckeled hills"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar3));
      ...
      neighbors.put("TER_$Grassland",39);
      neighbors.put("TER_$Tall_grass",1);
      pos = name.indexOf("$");
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar4 = {"Marching through grassy fields","Galloping through grassy fields","","","Swooping over grassy fields"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar4));
      ...
      name = "TER_$Tall_grass";
      fileNames = new ArrayList<String>();
      fileNames.add("images/terrain/tallgrass.GIF");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("TER_$Grassland",60);
      neighbors.put("TER_$Forest",40);
      pos = name.indexOf("$");
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar4b = {"Wading through tall grass","Galloping through tall grass","","","Swooping over grassy fields"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar4b));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar5 = {"Trodding upon dry grass","Riding over crunchy dry grass","","","Soaring over dry grass"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar5));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar6 = {"Plodding over sandy dunes","Trotting over sandy plains","","","Flying over sandy plains"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar6));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar7 = {"Stumbling through dense forest","Riding through dense forest","","","Soaring over dense forest"};   
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar7));
      ...
      neighbors.put("TER_$High_grassland",30);
      neighbors.put("TER_$Tall_grass",10);
      pos = name.indexOf("$");
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar8 = {"Strolling through the forest","Galloping through the forest","","","Gliding over a green forest"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar8));
      
      name = "TER_S_$Bog";
      fileNames = new ArrayList<String>();
      fileNames.add("images/terrain/bog.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("TER_S_$Bog",55);
      neighbors.put("TER_S_$PoisonBog",5);
      neighbors.put("TER_V_$Shallow_water",20);
      neighbors.put("TER_$Tall_grass",20);
      pos = name.indexOf("$");
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar9 = {"Sludging through a slimy bog","Trotting through a misty bog","","","Swooping over a swampy bog"};   
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar9));
      
      name = "TER_S_$PoisonBog";
      fileNames = new ArrayList<String>();
      fileNames.add("images/terrain/poison.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("TER_S_$PoisonBog",20);
      neighbors.put("TER_S_$Bog",55);
      neighbors.put("TER_V_$Shallow_water",15);
      neighbors.put("TER_$Tall_grass",10);
      pos = name.indexOf("$");
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar10 = {"Sludging through foul smelling filth","Trotting over wretched waste","","","Swooping over smelly slime"};   
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar10));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar11 = {"Wading in shallow waters","Trotting through shallow waters","Rowing through shallow waters","Sailing through shallow waters","Gliding over shallow waters"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar11));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar12 = {"Treading for life in deep waters","","Rowing over deep waters","Sailing through deep waters","Soaring over deep waters"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar12));
      //20
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar13 = {"Struggling for life in rapid waters","","Fighting the currents of rapid waters","Struggling to sail through rapid waters","Flying over rapid waters"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar13));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar14 = {"Burning in molten lava","","","","Soaring over molten lava"};   
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar14));
      ...
      if(pos >= 0)
         description = name.substring(pos+1); 
      String [] nar15 = {"Strolling through a dead forest","Galloping through a dead forest","","","Gliding over a misty dead forest"};
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++, nar15));
      ...
      name = "LOC_L_1_$Camp";
      fileNames = new ArrayList<String>();
      fileNames.add("images/locations/camp1.GIF");
      fileNames.add("images/locations/camp2.GIF");
      fileNames.add("images/locations/camp3.GIF");
      fileNames.add("images/locations/camp4.GIF");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("TER_$Grassland",40);
      neighbors.put("TER_$High_grassland",20);
      neighbors.put("TER_S_$Hills",15);
      ...
      name = "LOC_$Sewer_stairs";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/doors/stairs.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_I_B_$Blue_Brick",50);
      neighbors.put("INR_I_B_L_4_$Blue_Brick_Torch",50);
      pos = name.indexOf("$");
      if(pos >= 0)
         description = name.substring(pos+1); 
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++));
      ...
      name = "INR_I_B_$Gray_Tile_Wall";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/walls/grayTile.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_I_B_$Gray_Tile_Wall",100);
      pos = name.indexOf("$");
      if(pos >= 0)
         description = name.substring(pos+1); 
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++));
      ...
      name = "INR_I_L_8_$Fire_pit";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/fire1.GIF");
      fileNames.add("images/indoor/fire2.GIF");
      fileNames.add("images/indoor/fire3.GIF");
      fileNames.add("images/indoor/fire4.GIF");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_$Black_floor",100);
      pos = name.indexOf("$");
      if(pos >= 0)
      ...
      name = "INR_I_$Iron_bar_door_locked";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/doors/ironBarDoor.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_$Black_floor",100);
      pos = name.indexOf("$");
      if(pos >= 0)
      ...
      name = "INR_D_$Iron_bar_door";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/doors/ironBarDoorUnlocked.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_$Black_floor",100);
      pos = name.indexOf("$");
      if(pos >= 0)
      ...
      name = "INR_I_L_3_$Sign_bounty";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/signs/bounty.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_$Black_floor",100);
      pos = name.indexOf("$");
      if(pos >= 0)
      ...
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++));
      //123
      name = "INR_I_$Red_Ship_Wall";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/walls/shipSide.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_I_$Red_Ship_Wall",100);
      pos = name.indexOf("$");
      if(pos >= 0)
         description = name.substring(pos+1); 
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++));
      
      //can only go up to 127 since it is stored in a byte.  If we want more, we will have to change the Terrain value to an int
      return terrain;
   }
}