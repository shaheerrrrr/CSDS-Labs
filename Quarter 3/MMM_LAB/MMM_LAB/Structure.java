 ...
 //STRUCTURE OBJECT  
   ...
   public class Structure extends Entity
   {
            ...
            if(super.getName().endsWith("LANDMARK") && height == 2)  
               ...
               if(super.getName().equals("ELEC TOWER 0"))  
                  ...
                  if(super.getName().startsWith("WATER TOWER"))  
                     ...
                     if(super.getName().equals("ELEC TOWER 1") || super.getName().contains("sludge"))  
                        heightDiff = 0;
                     else
      ...
      {
         if(super.getName().contains("sludge") && health == 0)
            return true;
         return false;
      }
      ...
      public boolean canShootOver(Projectile b)
      {
         if(b.inAir())
            return true;
         if(super.getName().contains("sludge"))
         { //shells and fire will damage and destroy sludge
